window.ERGONOMICS_SUMMARY = {
  "generatedAt": "2026-04-15T18:57:23.487Z",
    ...
    },
    {
      ...
      "goals": [
        ...
        },
        {
          ...
          "pageRef": "P3, 19",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>구조</th><th>구성/작동</th><th>핵심 기능/수치</th></tr></thead><tbody><tr><td><strong>Outer</strong></td><td>Pinna + Canal + Eardrum</td><td>canal resonance <strong>2~5kHz에서 max 12dB</strong></td></tr><tr><td><strong>Middle</strong></td><td><strong>Malleus→Incus→Stapes</strong> / <strong>Acoustic reflex</strong> (stapedius 수축)</td><td>oval window pressure <mark><strong>~22× 증폭</strong></mark></td></tr><tr><td><strong>Inner</strong></td><td><strong>Cochlea</strong> + <strong>Basilar membrane</strong> + <strong>Organ of Corti</strong></td><td>fluid→neural 변환, <strong>Tonotopic organization</strong></td></tr><tr><td><strong>Acoustic Reflex</strong></td><td>trigger <strong>~80dB</strong> above threshold</td><td>attenuation max <strong>20dB</strong>, sustain <strong>max 15min</strong>, <strong>Latency 35~150ms</strong> → impulse noise 보호 불가 ⚠</td></tr></tbody></table></div>",
          "answerHighlightCount": 1,
          "answerLines": [
            "| <strong>Middle</strong> | <strong>Malleus→Incus→Stapes</strong> / <strong>Acoustic reflex</strong> (stapedius 수축) | oval window pressure <mark><strong>~22× 증폭</strong></mark> |"
          ]
        },
        {
          ...
          "pageRef": "P3, 21",
          "html": "<ul><li>두 이론은 <strong>complementary</strong></li></ul><div class=\"table-scroll\"><table><thead><tr><th>이론</th><th>작동 원리</th><th>주파수 범위</th><th>한계/특징</th></tr></thead><tbody><tr><td><strong>Place</strong></td><td>basilar membrane <strong>특정 위치</strong>에서 max vibration</td><td>effective <strong>1,000~5,000 Hz</strong></td><td>high freq→oval window 근처, low freq→apex</td></tr><tr><td><mark><strong>Temporal</strong></mark></td><td>nerve fires in <strong>temporal pattern</strong> matching freq</td><td>effective <strong>&lt; 1,000 Hz</strong></td><td>한계: <strong>&gt;1,000 firings/s 불가</strong></td></tr></tbody></table></div>",
          "answerHighlightCount": 1,
          "answerLines": [
        ...
        },
        {
          ...
          "pageRef": "P4, 30",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>항목</th><th>조건/수치</th><th>설계 의미</th></tr></thead><tbody><tr><td><strong>JND</strong></td><td><strong>50%</strong> probability로 감지 가능한 minimum change</td><td>감지 가능한 최소 변화 기준</td></tr><tr><td><strong>Intensity JND</strong></td><td><strong>≥60dB</strong> above threshold에서 smallest, <strong>1,000 &amp; 4,000 Hz</strong>에서 best</td><td>강도 변화 구분이 쉬운 조건</td></tr><tr><td><strong>Frequency JND</strong></td><td><strong>&lt;1,000 Hz</strong>에서 smallest, intensity <strong>≥30dB</strong>, duration <strong>&gt;0.1s</strong> 필요</td><td>주파수 변화 구분 조건</td></tr><tr><td><strong>Absolute ID</strong> (Miller)</td><td>Intensity <strong>4-5</strong> / Frequency <mark><strong>4-7</strong></mark> / Duration <strong>2-3</strong> / combined <strong>9 levels</strong></td><td>한 차원에 너무 많은 단계 배정 금지</td></tr><tr><td>전략</td><td><strong>MORE dimensions × FEWER steps</strong></td><td>여러 차원에 적은 단계씩 분산</td></tr></tbody></table></div>",
          "answerHighlightCount": 1,
          "answerLines": [
            "| <strong>Absolute ID</strong> (Miller) | Intensity <strong>4-5</strong> / Frequency <mark><strong>4-7</strong></mark> / Duration <strong>2-3</strong> / combined <strong>9 levels</strong> | 한 차원에 너무 많은 단계 배정 금지 |"
          ]
        },
        {
          ...
          "pageRef": "P4, 31",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>단서</th><th>주파수 범위</th><th>역할</th></tr></thead><tbody><tr><td><strong>ITD</strong> (Interaural Time Diff)</td><td><strong>&lt;1,500 Hz</strong></td><td>~<strong>0.8ms</strong> difference</td></tr><tr><td><strong>ILD</strong> (Interaural Level Diff)</td><td><strong>&gt;3,000 Hz</strong></td><td>head shadow</td></tr><tr><td><strong>Spectral Cues (Pinna)</strong></td><td>all freq</td><td><strong>up-down localization</strong></td></tr><tr><td><strong>Head Movement</strong></td><td>all freq</td><td>resolves <strong>front-back ambiguity</strong></td></tr></tbody></table></div>",
          "answerHighlightCount": 0,
          "answerLines": []
        },
        {
          ...
          "pageRef": "P4, 33",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>원칙</th><th>의미</th></tr></thead><tbody><tr><td><strong>Compatibility</strong></td><td>high pitch=&quot;up&quot;, fast rate=&quot;urgent&quot;</td></tr><tr><td><mark><strong>Approximation</strong></mark></td><td>2-stage — Attention signal → Designation signal</td></tr><tr><td><mark><strong>Dissociability</strong></mark></td><td>background noise/speech와 명확 구분</td></tr><tr><td><strong>Parsimony</strong></td><td>필요 정보만</td></tr><tr><td><strong>Invariance</strong></td><td>same signal=same info</td></tr><tr><td><strong>Standardization</strong></td><td>consistent coding</td></tr></tbody></table></div>",
          "answerHighlightCount": 2,
          "answerLines": [
      ...
      "goals": [
        {
          ...
          "pageRef": "Page 6",
          "html": "<p><strong>8가지 알람 장치 특성 비교</strong> (Intensity / Frequency / Attention-getting / Noise-penetration):</p><div class=\"table-scroll\"><table><thead><tr><th>장치</th><th>강도</th><th>주파수</th><th>주의획득</th><th>소음투과</th></tr></thead><tbody><tr><td><strong>Diaphone(foghorn)</strong></td><td>Very high intensity</td><td>Very low freq</td><td>Good attention</td><td>저주파 소음에서 Poor</td></tr><tr><td><strong>Horn</strong></td><td>High intensity</td><td>Low~High freq</td><td>Good attention</td><td>Good penetration</td></tr><tr><td><strong>Whistle</strong></td><td>High intensity</td><td>Low~High freq</td><td><strong>intermittent일 때</strong> Good</td><td>주파수 적절히 선택 시 Good</td></tr><tr><td><strong>Siren</strong></td><td>High intensity</td><td>Low~High freq</td><td><strong>pitch 오르내릴 때 Very good</strong></td><td>rising/falling freq → Very good penetration</td></tr><tr><td><strong>Bell</strong></td><td>Medium intensity</td><td>Med~High freq</td><td>Good</td><td>저주파 소음에서 Good</td></tr><tr><td><strong>Buzzer</strong></td><td>Low~Med intensity</td><td>Low~Med freq</td><td>Good</td><td>Fair (스펙트럼이 배경 소음에 맞을 때)</td></tr><tr><td><strong>Chimes &amp; Gong</strong></td><td>Low~Med</td><td>Low~Med</td><td>Fair</td><td>Fair</td></tr><tr><td><strong>Oscillator</strong></td><td>Low~High</td><td>Med~High</td><td><strong>intermittent일 때</strong> Good</td><td>주파수 적절히 선택 시 Good</td></tr></tbody></table></div><p><strong>설계 권장사항</strong> (Page 7):</p><div class=\"table-scroll\"><table><thead><tr><th>상황/목표</th><th>권장 설계</th></tr></thead><tbody><tr><td>일반 주파수 범위</td><td><strong>200~5,000 Hz</strong> 일반용; <mark><strong>500~3,000 Hz</strong></mark> 선호 (귀 민감도 peak)</td></tr><tr><td><strong>장거리</strong></td><td>&lt; 1,000 Hz 사용 (고주파는 300m 넘으면 감쇠)</td></tr><tr><td><strong>장애물 통과</strong></td><td>&lt; 500 Hz (저주파가 벽/장벽 우회)</td></tr><tr><td><strong>변조 신호</strong></td><td>modulated &gt; steady tone: 1~8 beeps/s 또는 warbling 1~3 Hz</td></tr><tr><td>배경소음 회피</td><td>배경소음이 약한 주파수 대역 선택 (<strong>spectral separation</strong>)</td></tr><tr><td>다중 경고</td><td>각각 <strong>구별 가능</strong>해야 하며, 중간 강도 <strong>85~95 dBA</strong> 사용</td></tr><tr><td>오디오 채널</td><td><strong>전용 채널</strong> 사용 (다른 오디오 소스와 공유 금지)</td></tr></tbody></table></div><p><strong>Reaction Time</strong> (Page 8):</p><div class=\"table-scroll\"><table><thead><tr><th>신호</th><th>패턴</th><th>결과</th></tr></thead><tbody><tr><td><strong>Beep</strong></td><td>intermittent horn 425 Hz, on 0.7s / off 0.6s</td><td>best</td></tr><tr><td><strong>Yeow</strong></td><td>descending freq sweep 800→100 Hz every 1.4s</td><td>best</td></tr><tr><td><strong>Wail</strong></td><td>slow freq rise 400→925 Hz over 3.8s</td><td>worst</td></tr><tr><td><strong>Simple RT</strong></td><td>intensity 높을수록</td><td>반응 빠름 (monotonic)</td></tr><tr><td><strong>Choice RT</strong></td><td><strong>중간 강도(85~95 dBA)</strong></td><td>가장 빠름; 고강도 → <strong>startle reflex</strong> → 선택 반응(response selection) 저하</td></tr></tbody></table></div>",
          "answerHighlightCount": 1,
          "answerLines": [
            "| 일반 주파수 범위 | <strong>200~5,000 Hz</strong> 일반용; <mark><strong>500~3,000 Hz</strong></mark> 선호 (귀 민감도 peak) |"
          ]
        },
        {
          "key": "audition-and-speech-communication-part-2-goal-2",
          "number": 2,
        ...
        {
          "key": "audition-and-speech-communication-part-2-goal-3",
          "number": 3,
          ...
          "pageRef": "Page 11",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>구분</th><th>음향 특성</th><th>명료도 영향</th></tr></thead><tbody><tr><td><mark><strong>Vowels(모음)</strong></mark></td><td>음향 파워 높음 → 소음 마스킹에 저항력 있음</td><td><strong>명료도 기여 낮음</strong></td></tr><tr><td><mark><strong>Consonants(자음)</strong></mark></td><td>음향 파워 낮음 → 소음에 <strong>쉽게 마스킹</strong></td><td><strong>명료도의 핵심 단서</strong> 제공</td></tr><tr><td>실용적 함의</td><td>소음 환경에서 자음 손실</td><td>곧 명료도 하락 → 자음 보존이 설계 핵심</td></tr></tbody></table></div><p><strong>Speech Spectrum</strong> (Page 12):</p><div class=\"table-scroll\"><table><thead><tr><th>항목</th><th>핵심 내용</th></tr></thead><tbody><tr><td>대화 수준</td><td><strong>55~65 dBA</strong>; 큰 소리 최대 <strong>85 dBA</strong></td></tr><tr><td>성별 차이</td><td>남성: 여성보다 <strong>3~5 dB</strong> 더 크고, 저주파 에너지 더 많음</td></tr><tr><td>이해도 결정</td><td><mark><strong>Band-specific SNR</strong></mark>이 이해도 결정</td></tr></tbody></table></div><div class=\"table-scroll\"><table><thead><tr><th>발화 수준</th><th>dBA</th></tr></thead><tbody><tr><td>Weak</td><td>45 dBA</td></tr><tr><td>Normal</td><td>55 dBA</td></tr><tr><td>Telephone·Lecture</td><td>65 dBA</td></tr><tr><td>Loud</td><td>75 dBA</td></tr><tr><td>Shouting</td><td>85 dBA</td></tr></tbody></table></div><p><strong>Speech Visualization</strong> (Page 13):</p><div class=\"table-scroll\"><table><thead><tr><th>도구</th><th>축/표현</th><th>용도</th></tr></thead><tbody><tr><td>Waveform</td><td>시간-강도</td><td>시간에 따른 음성 강도 변화</td></tr><tr><td>Spectrogram</td><td>시간-주파수+강도 음영</td><td>시간별 주파수 구성과 강도 확인</td></tr><tr><td>Spectrum</td><td>주파수-강도</td><td>특정 시점의 주파수별 강도 확인</td></tr></tbody></table></div>",
          "answerHighlightCount": 3,
          "answerLines": [
            "| <mark><strong>Vowels(모음)</strong></mark> | 음향 파워 높음 → 소음 마스킹에 저항력 있음 | <strong>명료도 기여 낮음</strong> |",
            "| <mark><strong>Consonants(자음)</strong></mark> | 음향 파워 낮음 → 소음에 <strong>쉽게 마스킹</strong> | <strong>명료도의 핵심 단서</strong> 제공 |",
            "| 이해도 결정 | <mark><strong>Band-specific SNR</strong></mark>이 이해도 결정 |"
          ]
        },
        {
          ...
          "pageRef": "Page 14",
          "html": "<div class=\"table-scroll\"><table><thead><tr><th>기준</th><th><mark><strong>Speech Intelligibility(명료도)</strong></mark></th><th><mark><strong>Speech Quality(품질)</strong></mark></th></tr></thead><tbody><tr><td>측정 대상</td><td>메시지 이해도 (% words recognized, accuracy)</td><td>자연스러움·유쾌함</td></tr><tr><td>측정 방식</td><td>청자에게 전송 → 듣고 반복/질문 응답으로 평가</td><td><strong>선호도 평점</strong>(excellent→unacceptable) 또는 비교 선호 테스트</td></tr><tr><td>의존 단서</td><td><strong>자음 + 문맥 단서</strong>에 의존</td><td><strong>모음, 운율(prosody), fidelity</strong>에 의존</td></tr><tr><td>가능한 특징</td><td>로봇/합성 음성에서도 높을 수 있음</td><td>화자 식별·사용자 만족에 중요 (전화통화 등)</td></tr><tr><td>중요한 시스템</td><td><strong>경고, 군사, 안전 시스템</strong>에 핵심</td><td>장기 사용 수용성에 필수</td></tr><tr><td>핵심 대비</td><td>Intelligibility = <strong>정보 전달 정확도</strong></td><td>Quality = <strong>화자 정체성·현실감</strong></td></tr></tbody></table></div>",
          "answerHighlightCount": 2,
          "answerLines": [
            "| 기준 | <mark><strong>Speech Intelligibility(명료도)</strong></mark> | <mark><strong>Speech Quality(품질)</strong></mark> |"
          ]
        },
        {
          "key": "audition-and-speech-communication-part-2-goal-5",
          "number": 5,
          "heading": "Explain the components of a speech communication system. (음성 통신 시스템 구성 요소 설명)",
          "pageRef": "Page 16",
          "html": "<ul><li><strong>4대 구성 요소</strong>: <strong>Speaker</strong> → <strong>Message</strong> → <strong>Transmission System</strong> → <strong>Listener</strong></li><li><strong>Environment</strong>(Noise, Room)가 전 과정에 영향</li></ul><div class=\"table-scroll\"><table><thead><tr><th>구성 요소</th><th>명료도 영향</th></tr></thead><tbody><tr><td><strong>Speaker</strong></td><td>발음, 억양, 리듬, 명확한 발성, 속도, 유창성 (Page 17)</td></tr><tr><td><strong>Message</strong></td><td>음소 혼동, 어휘 특성, 문맥 특성</td></tr><tr><td><strong>Transmission</strong></td><td>필터링, 클리핑, 잔향</td></tr><tr><td><strong>Listener</strong></td><td>청력, 나이, 청력 보호구, 훈련</td></tr><tr><td><strong>Environment</strong></td><td>소음, 잔향</td></tr></tbody></table></div>",
          "answerHighlightCount": 0,
          "answerLines": []
        },
        {
          "key": "audition-and-speech-communication-part-2-goal-6",
          "number": 6,
          "heading": "Describe the acoustic characteristics of a speaker with high speech intelligibility. (높은 명료도 화자의 음향적 특성)",
          "pageRef": "Page 18",
          "html": "<p>Bilger, Hanley &amp; Steer (1955) 연구: 우수 화자 vs 비명료 화자의 <strong>4가지 음향 차이</strong>:</p><div class=\"table-scroll\"><table><thead><tr><th>특성</th><th>효과</th></tr></thead><tbody><tr><td><strong>Longer syllable duration(긴 음절 지속시간)</strong></td><td>청자 청각 시스템이 각 음소를 통합할 시간 확보</td></tr><tr><td><strong>Greater speech intensity(높은 음성 강도)</strong></td><td>배경 소음 대비 <strong>S/N ratio 향상</strong></td></tr><tr><td><strong>More speech time / fewer pauses(적은 휴지기)</strong></td><td>전송 시간 효율적 사용, 청자 주의 유지</td></tr><tr><td><strong>Greater vocal frequency variation(큰 음성 주파수 변화)</strong></td><td>pitch 변화가 리듬 구조·주의 조절 개선</td></tr></tbody></table></div><ul><li><strong>Speech training</strong>: 조음·명료도 <strong>moderate 수준</strong> 개선 가능, but 조음기관의 구조적 차이는 대부분 고정</li></ul>",
          "answerHighlightCount": 0,
          "answerLines": []
        },
        {
          ...
          "pageRef": "Page 19",
          "html": "<ul><li><strong>Phoneme confusions</strong>: 혼동 잘 되는 음소 그룹 → MNDGBVZ, TKPFS</li></ul><p><strong>Word features</strong>:</p><div class=\"table-scroll\"><table><thead><tr><th>설계 원칙</th><th>이유</th></tr></thead><tbody><tr><td><strong>Word-spelling alphabet</strong> (alpha, bravo, charlie) &gt; 단일 문자 (A, B)</td><td>명료도 향상</td></tr><tr><td><strong>익숙한 단어</strong> &gt; 낯선 단어</td><td>친숙성이 인식 보조</td></tr><tr><td><strong>긴 단어</strong> &gt; 짧은 단어</td><td>음성 단서 더 많아서 식별 용이</td></tr></tbody></table></div><p><strong>Context features</strong>:</p><div class=\"table-scroll\"><table><thead><tr><th>설계 원칙</th><th>이유</th></tr></thead><tbody><tr><td><strong>Sentences &gt; isolated words &gt; nonsense syllables</strong></td><td>문맥이 지각 보조</td></tr><tr><td><mark><strong>어휘 수(vocabulary)가 작을수록</strong></mark></td><td>소음 환경에서 명료도 향상</td></tr><tr><td><mark><strong>표준 문장 구조</strong></mark> 사용 + 정보 전달 순서 고정</td><td>예: bin location, part number, part name, quantity</td></tr><tr><td>수신자에게 사용될 어휘·문장 구조 <strong>사전 숙지</strong> 시키기</td><td>예측 가능한 어휘·구조가 인식 보조</td></tr></tbody></table></div><p><strong>효과적 메시지 설계 가이드라인 4가지</strong>:</p><div class=\"table-scroll\"><table><thead><tr><th>번호</th><th>가이드라인</th></tr></thead><tbody><tr><td>1</td><td>짧은 단어/단일 문자 피하기 → word-spelling alphabet 사용</td></tr><tr><td>2</td><td>어휘 수 최소화</td></tr><tr><td>3</td><td>표준 문장 구조 사용</td></tr><tr><td>4</td><td>수신자에게 어휘·문장 구조 사전 교육</td></tr></tbody></table></div>",
          "answerHighlightCount": 2,
          "answerLines": [
        ...
        {
          "key": "audition-and-speech-communication-part-2-goal-8",
          "number": 8,
          "heading": "Apply human factors guidelines for integrating synthesized speech into systems. (합성 음성 시스템 통합 가이드라인 적용)",
          "pageRef": "Page 28",
          "html": "<p><strong>합성 음성 유형</strong> (Page 26):</p><div class=\"table-scroll\"><table><thead><tr><th>유형</th><th>장점</th><th>한계</th><th>핵심 포인트</th></tr></thead><tbody><tr><td><strong>Analog/Digital Recording</strong></td><td>매우 높은 품질, 자연스러움</td><td>고정 어휘만 가능, 대용량 저장</td><td>8,000 samples/s</td></tr><tr><td><strong>Synthesis by Analysis(압축 디지털화, LPC)</strong></td><td>저장 공간 절약, 녹음 수준 품질</td><td>고정 어휘, 단어 연결 시 <mark><strong>부자연스러운 coarticulation</strong></mark></td><td>예: &#39;bookcase&#39; = /k/ 두 번</td></tr><tr><td><strong>Synthesis by Rule(TTS)</strong></td><td><strong>무제한 어휘</strong>, 메모리 최소, 새 어휘에 화자 불필요</td><td>품질 낮음, prosody 모델링 어려움</td><td>새 어휘 생성 가능</td></tr></tbody></table></div><p><strong>합성 음성 성능</strong> (Page 27):</p><div class=\"table-scroll\"><table><thead><tr><th>항목</th><th>내용</th></tr></thead><tbody><tr><td>명료도 비교</td><td>자연 음성 99% vs 최고 합성 95% vs 최악 합성 84%</td></tr><tr><td><strong>Adaptation effect</strong></td><td>짧은 노출/훈련으로 명료도 크게 향상</td></tr><tr><td><strong>Memory burden</strong></td><td>합성 음성은 자연 음성보다 <strong>처리 용량 더 필요</strong> → 메시지 기억 어려움</td></tr><tr><td>해결책</td><td><mark><strong>inter-word interval 증가</strong></mark> (1s→5s로 recall 거의 2배), pause-grouped digit strings</td></tr></tbody></table></div><p><strong>사용자 선호도</strong> (Page 29):</p><div class=\"table-scroll\"><table><thead><tr><th>항목</th><th>내용</th></tr></thead><tbody><tr><td>Intelligibility =/= Preference</td><td>명료해도 불쾌할 수 있음</td></tr><tr><td>합성 음성 묘사</td><td>machinelike, choppy, harsh/grainy, flat, noisy</td></tr><tr><td>조종석 조종사</td><td><strong>기계적 목소리 선호</strong> (인간 승무원 음성과 구별 위해)</td></tr><tr><td><strong>Intonation pattern</strong></td><td>continuant(rising pitch) 그룹 전달이 선호됨</td></tr></tbody></table></div><p><strong>8가지 가이드라인</strong> (Page 30):</p><div class=\"table-scroll\"><table><thead><tr><th>가이드라인</th><th>적용 의미</th></tr></thead><tbody><tr><td><strong>Voice differentiation</strong></td><td>경고 음성은 시스템 내 다른 음성과 <strong>질적으로 다르게</strong> (특히 조종석)</td></tr><tr><td><strong>Alerting tones</strong></td><td>경고 전용이면 사전 경고음 불필요; 비경고 정보도 있으면 <strong>경고 전용 tone 추가</strong></td></tr><tr><td><strong>Maximize intelligibility</strong></td><td>안전-critical 메시지에서 명료도 최대화 설정</td></tr><tr><td><strong>Natural voice for general use</strong></td><td>일반 정보는 자연스러운 목소리로 <strong>사용자 수용성</strong> 향상</td></tr><tr><td><strong>Replay mode</strong></td><td>복잡한 정보에 <strong>재생 기능</strong> 제공 (단, 실제 사용률 낮음 - Roelofs, 1987)</td></tr><tr><td><strong>User interrupt</strong></td><td>숙련 사용자가 메시지 <strong>중간에 중단</strong> 가능하게 → 효율성</td></tr><tr><td><strong>Training period</strong></td><td>운영 전 시스템 음성에 <strong>사전 노출</strong> 제공</td></tr><tr><td><strong>Use sparingly</strong></td><td>시각 대안보다 <strong>확실히 우수할 때만</strong> 사용 (&#39;high-tech fever&#39; 경계)</td></tr></tbody></table></div>",
          "answerHighlightCount": 2,
          "answerLines": [
            "| <strong>Synthesis by Analysis(압축 디지털화, LPC)</strong> | 저장 공간 절약, 녹음 수준 품질 | 고정 어휘, 단어 연결 시 <mark><strong>부자연스러운 coarticulation</strong></mark> | 예: &#39;bookcase&#39; = /k/ 두 번 |",
